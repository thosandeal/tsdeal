...
const mfp = {
    ...
    taogr: async function (pname, pvitri, pbanner) {
        ...
        if (pvitri) {
            ...
            await this.pppinput('input[type="search"][role="combobox"][aria-label="Vị trí nhóm"]',1,pvitri); // nhập vị trí
    ...
    toiUuPage: async function (pcode, puid, pavatar, pbanner, pcity, pzip, pvitri, pphonev1, pphonev2, pmail, pweb, pmess) {
        ...
        await this.pppinput(`//div[span[text()='Số điện thoại']]//input[@type='text']`, 1, pphonev2.toString());
        await page.waitForTimeout(2000);
        await this.pcheckclickx('//span[text()="Lưu"]', 1, 3000); // lưu 
